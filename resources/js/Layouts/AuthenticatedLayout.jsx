                    ...
                    <div className="flex h-16 justify-between">
                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-lg">
                                            <button
                                                type="button"
                                                className="inline-flex items-center rounded-lg px-3 py-2 text-sm font-medium text-slate-600 transition hover:bg-slate-100 hover:text-slate-900 focus:outline-none"
                                            >
                                                {user.name}
                        ...
                        <div className="-me-2 flex items-center sm:hidden">
                            <button
                                ...
                                className="inline-flex items-center justify-center rounded-lg p-2 text-slate-500 transition hover:bg-slate-100 focus:outline-none"
                            >
